use vortex__::account::{validate_email, validate_password, validate_username};
...
fn test_validate_password() {
    ...
    assert!(!validate_password(
        "Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test1234!Test"
    ));
    assert!(!validate_password("test1234!"));
    assert!(!validate_password("TEST1234!"));
...
fn test_validate_username() {
    ...
    assert!(!validate_username(
        "thisusernameiswaytoolongandexceedslimit"
    ));
...
fn test_validate_email() {
    ...
    assert!(!validate_email(
        "test@example.com/verylongsubdomainthatexceedsthelimit"
    ));
}
...
fn test_validate_group_name() {
    ...
    assert!(!validate_group_name(
        "This group name is way too long and exceeds the fifty character limit"
    ));
    assert!(!validate_group_name(""));
